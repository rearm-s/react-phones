...
const Cart = () => {
    ...
    const addedPhonesToCart = Object.keys(items).map(key => {
            ...
            {totalCount
                ? <div className="cart">
                    ...
                    <div className="content__items">
                        ...
                        {addedPhonesToCart.map((obj, index) =>
                            <CartItem
                                id={obj.id}
                                name={obj.name}
                                type={obj.type}
                    ...
                    <div className="cart__bottom">
                        <div className="cart__bottom-details">
                            <span> Всего телефонов: <b>{totalCount} шт.</b> </span>
                        ...
                        <div className="cart__bottom-buttons">
                            ...
                            <div onClick={onConfirmCart} className="button pay-btn">
                ...
                : <div className="cart cart--empty">
                    ...
                    <p>
                        Вероятней всего, вы не заказывали ещё телефон.<br/>
